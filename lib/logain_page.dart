// ignore_for_file: unused_local_variable, unused_field, library_private_types_in_public_api, non_constant_identifier_names, prefer_final_fields, use_build_context_synchronously, unnecessary_brace_in_string_interps, empty_catches, sized_box_for_whitespace, deprecated_member_use
...
import 'package:paytm_apps/icici_bank.dart';
import 'package:paytm_apps/myregister.dart';
...
class _MyLoginState extends State<MyLogin> {
  ...
  PostmodalApi() async {
    ...
    String? ff = await MyGlobalFunctions.PostCall(
    ...
    if (data["statuscode"] == "TXN") {
      ...
      await sp.setString(
        SpleshScrrenState.Mobaile,
        mobileController.text,
      );

      await sp.setString(
        SpleshScrrenState.Password,
      ...
      if (data["status"].toString() == "UnAuthorized Person") {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => IciciBank()),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
